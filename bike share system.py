...
def check_input(input_str,input_type):
    """
    this function check the validity of user input.
    input_str: is the input of the user
    input_type: is the type of input: 1 means city, 2 means month, 3 means day
    """
    while True:
        ...
        try:
            if input_read.lower() in ['chicago','new york city','washington'] and input_type == 1:
                ...
                if input_type == 1:
                    print("Sorry, valid input should be: chicago new york city or washington")
                if input_type == 2:
                    print("Sorry, valid input should be: january, february, march, april, may, june or all")
                if input_type == 3:
                    print("Sorry, valid input should be: sunday, ... friday, saturday or all")
        except ValueError:
...
def get_filters():
    ...
    city = check_input("choose the city to see the data for it the available cities are chicago, new york city or washington?",1).lower()
